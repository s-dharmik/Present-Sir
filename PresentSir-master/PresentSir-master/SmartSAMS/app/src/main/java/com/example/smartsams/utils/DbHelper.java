...
//     **/
//    public void insertTeacher(com.example.smartsams.Teacher teacher) {
//        SQLiteDatabase db = this.getWritableDatabase();
//        ContentValues contentValues = new ContentValues();
...
//    }
//
//    public void updateTeacher(com.example.smartsams.Teacher teacher) {
//        SQLiteDatabase db = this.getWritableDatabase();
//        ContentValues contentValues = new ContentValues();
//        contentValues.put(TEACHERS_NAME, teacher.getName());
//        contentValues.put(TEACHERS_POST, teacher.getPost());
...
//    }
//
//    public void deleteTeacherById(com.example.smartsams.Teacher teacher) {
//        SQLiteDatabase db = this.getWritableDatabase();
//        db.delete(TEACHERS, TEACHERS_ID + " =? ", new String[] {String.valueOf(teacher.getId())});
//        db.close();
//    }
//
//    public ArrayList<com.example.smartsams.Teacher> getTeacher() {
//        SQLiteDatabase db = this.getWritableDatabase();
//        ArrayList<com.example.smartsams.Teacher> teacherlist = new ArrayList<>();
//        com.example.smartsams.Teacher teacher;
//        Cursor cursor = db.rawQuery("SELECT * FROM " + TEACHERS, null);
//        while (cursor.moveToNext()) {
//            teacher = new com.example.smartsams.Teacher();

package com.example.smartsams.Director;
...
public class Director_home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private static final String TAG = Director_home.class.getSimpleName(); // getting the info
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_READ,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            progressDialog.dismiss();
                            Toast.makeText(Director_home.this, "Error Reading Details "+e.toString(), Toast.LENGTH_SHORT).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Toast.makeText(Director_home.this, "Error Reading Details "+error.toString(), Toast.LENGTH_SHORT).show();

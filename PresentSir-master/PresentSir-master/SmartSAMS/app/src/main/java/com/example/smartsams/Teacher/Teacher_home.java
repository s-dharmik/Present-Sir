...
import com.example.smartsams.activities.MainActivity;
...
import com.example.smartsams.faculty_profile;

public class Teacher_home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private static final String TAG = Teacher_home.class.getSimpleName(); // getting the info
    ...
    // variables for teacher navigation menu
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar1 = (Toolbar) findViewById(R.id.teacher_toolbar);
    ...
    private void eventrecyclerView() {
        ...
        event_location.add(new event_dashboard(R.drawable.sports, "SPORTS", "Event description is here","2/2/2021"));
        event_location.add(new event_dashboard(R.drawable.computerscience, "Department Events", "Event description is here", "4/2/2021"));
        event_location.add(new event_dashboard(R.drawable.natural, "Natural Events", "Event description is here", "5/2/2021"));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_READ,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            progressDialog.dismiss();
                            Toast.makeText(Teacher_home.this, "Error Reading Details "+e.toString(), Toast.LENGTH_SHORT).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Toast.makeText(Teacher_home.this, "Error Reading Details "+error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId())
        {
            case R.id.nav_profile:
                ...
                Intent intent = new Intent(this, faculty_profile.class);
   ...
   // call to attendance activity
    public void callAttendance(View view) {
        Intent intent = new Intent(this, take_and_view_attendance.class);
        startActivity(intent);
    }

    public void View_time_table_T(View view) {

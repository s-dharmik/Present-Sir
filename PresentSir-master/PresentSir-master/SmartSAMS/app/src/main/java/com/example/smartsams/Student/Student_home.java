package com.example.smartsams.Student;
...
import com.example.smartsams.Attendance.Student_view_attendance;
...
import com.example.smartsams.userprofile;

public class Student_home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private static final String TAG = Student_home.class.getSimpleName(); // getting the info
...
//    private static String URL_UPLOAD = "https://codmans.com/upload.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar1 = (Toolbar) findViewById(R.id.student_toolbar);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_READ,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            progressDialog.dismiss();
                            Toast.makeText(Student_home.this, "Error Reading Details "+e.toString(), Toast.LENGTH_SHORT).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Toast.makeText(Student_home.this, "Error Reading Details "+error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void View_Student_Attendance(View view) {
        Intent intent = new Intent(getApplicationContext(), Student_view_attendance.class);
        startActivity(intent);
    }

    public void View_time_table(View view) {
